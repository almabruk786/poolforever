...
export const defaultSiteContent: SiteContent = {
  ...
  heroImage: heroSlides[0]?.image || "/gallery/hero-pool.jpg",
  phone: contact.phone,
...
function normalizeProject(project: Partial<CmsProject> & Partial<ProjectInput> & { _id?: unknown }): CmsProject {
  ...
  return {
    ...
    image: stringValue(project.image, "/gallery/hero-pool.jpg"),
    images: images.length ? images : ["/gallery/hero-pool.jpg"],
